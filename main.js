...
const commands = {
  ...
  addAlbum : args => addAlbum(parseInt(args[0]),{name : args[1], year : args[2]}),
  addTrack : args => addTrack(parseInt(args[0]), {name : args[1], duration : args[2], genres : args.slice(3, args.length)}), 
